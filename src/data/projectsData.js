...
export const earlierBuilds = [
  ...
  },
  {
    ...
    description:
      "Shipping and logistics management system built during a hackathon. Features shipment tracking, order management, and a clean operations dashboard.",
  ...
  {
    slug: "deepx",
    title: "DeepX — NLP Hackathon",
    category: "NLP / AI",
    filterTags: ["AI / LLM"],
    role: "NLP Engineer",
    status: "Hackathon — Top 20 / 300",
    description:
      "Sentiment analysis NLP project built for the DeepX hackathon. Finished 20th out of 300 competing teams. Focused on text classification, sentiment scoring, and model evaluation pipelines.",
    image: null,
    tech: ["Python", "NLP", "Sentiment Analysis", "Text Classification", "ML Pipelines"],
