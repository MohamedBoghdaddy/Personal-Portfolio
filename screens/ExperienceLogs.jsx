  ...
  return (
    <main className="page-shell">
      <SectionHeader
        ...
        description="A clean timeline for career history, client work, project experience, and technical growth."
        icon="history"
      />

      <div className="relative ml-4 mt-xl border-l border-outline-variant/30 pb-xl md:ml-12">
        {experiences.map((exp, index) => (
          <div key={`${exp.company}-${exp.role}`} className="relative mb-xl pl-12 last:mb-0">
            <div className={`absolute -left-[9px] top-2 h-4 w-4 rounded-full border-4 border-background ${index === 0 ? "bg-primary shadow-[0_0_10px_rgba(75,226,119,0.6)]" : "bg-outline-variant"}`} />
            <GlassCard className="p-md">
              <div className="mb-sm flex flex-col justify-between gap-xs md:flex-row md:items-center">
                <div>
                  ...
                  <h2 className="font-display text-2xl md:text-3xl font-semibold">{exp.role}</h2>
                </div>
      ...
      <div className="grid grid-cols-1 gap-md md:grid-cols-3">
        {[
          ["hub", "542+", "Commits / Iterations"],
          ["memory", "AI", "Systems Built"],
          ["cloud_done", "QA", "Production Mindset"]
